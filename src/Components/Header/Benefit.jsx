    ...
    return (
        <div>
            <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1'>
                <div >
                    <img className='relative left-20' src={Img1} alt="" />
                    <div>
                ...
                <div >
                    <img className='relative left-20' src={Img2} alt="" />
                    <div>
                ...
                <div >
                    <img  className='relative left-20' src={Img3} alt="" />
                    <div>
                ...
                <div >
                    <img  className='relative left-20' src={Img4} alt="" />
                    <div>
